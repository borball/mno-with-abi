...
ssh 192.168.58.14 'kcli create vm -P uuid=22222222-1111-1111-0000-111100000064 -P start=False -P memory=30702 -P numcpus=16 -P disks=[122,150] -P nets=["{\"name\":\"br-vlan58\",\"nic\":\"eth0\",\"mac\":\"de:ad:be:ff:10:64\"}"] odf-worker1'
ssh 192.168.58.14 'kcli create vm -P uuid=22222222-1111-1111-0000-111100000065 -P start=False -P memory=30702 -P numcpus=16 -P disks=[122,150] -P nets=["{\"name\":\"br-vlan58\",\"nic\":\"eth0\",\"mac\":\"de:ad:be:ff:10:65\"}"] odf-worker2'
ssh 192.168.58.14 'kcli create vm -P uuid=22222222-1111-1111-0000-111100000066 -P start=False -P memory=30702 -P numcpus=16 -P disks=[122,150] -P nets=["{\"name\":\"br-vlan58\",\"nic\":\"eth0\",\"mac\":\"de:ad:be:ff:10:66\"}"] odf-worker3'
